...
type LogEntry struct {
	...
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // Commands are sent as raw bytes
...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\vRequestVote\x12\x18.raft.RequestVoteRequest\x1a\x19.raft.RequestVoteResponseB#Z!github.com/marksmwl/raft-kv/protob\x06proto3"
